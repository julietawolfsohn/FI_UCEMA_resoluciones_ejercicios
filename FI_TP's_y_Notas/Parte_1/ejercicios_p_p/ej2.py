...
# ¿Cuál es el estado de un BrujoHogwarts? El estado de BrujoHogwarts es self.puntos, self.mascota, self.casa, self.escoba y jugar_quidditch y recitar_himno_de_la_casa
# self.puntos, self.mascota, self.casa, self.escoba 
